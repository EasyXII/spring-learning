...
public class Mail {
	public Mail(Person  person) {
		try {
			...
			// 设置e-mail内容			
			message.setContent(person.getName()+"：请经常访问本网站！" +
					"  <br><a href='http://localhost:8080/Board/EmailServlet?id="+person.getId()+"&active="+person.getActive()+"'>请点击激活帐号</a>", "text/html;charset=UTF-8");
			...
			// 连接到SMTP服务器
			transport.connect("smtp.qq.com", "1095580075", "ypewqlbjoosrhhff");// !!!!!******注意修改************
			// 发送e-mail
